...
int GenerateMiniDump(PEXCEPTION_POINTERS pExceptionPointers)
{
    ...
    MVPublic::newDir(App::appPath+"/crash");
    //文件格式
    swprintf(szFileName, L"crash/%s_crash_%04d%02d%02d-%02d%02d%02d.dmp",
        App::appName.toStdString().c_str(),stLocalTime.wYear, stLocalTime.wMonth, stLocalTime.wDay,
